  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Agregar al nuevo Encargado</h5>
      ...
      <form action="codee.php" method="POST">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nombre_e" class="form-control" placeholder="Introduzca el nombre">
            </div>
            <div class="form-group">
                <label>Correo</label>
